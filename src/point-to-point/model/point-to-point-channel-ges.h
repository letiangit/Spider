...
#ifndef POINT_TO_POINT_CHANNEL_GES_H
#define POINT_TO_POINT_CHANNEL_GES_H
 ...
 * \see TransmitStart
 */
class PointToPointChannelGES : public Channel 
{
public:
  /**
   ...
   * \param src Source PointToPointNetDeviceGES
  ...
  /**
   * \brief Get PointToPointNetDeviceGES corresponding to index i on this channel
   * \param i Index number of the device requested
   * \returns Ptr to PointToPointNetDeviceGES requested
   */
  Ptr<PointToPointNetDeviceGES> GetPointToPointDevice (uint32_t i) const;
...
protected:
   ...
   * \returns Ptr to PointToPointNetDeviceGES source for the 
   * specified link
   */
  Ptr<PointToPointNetDeviceGES> GetSource (uint32_t i) const;

  /**
   * \brief Get the net-device destination
   * \param i the link requested
   * \returns Ptr to PointToPointNetDeviceGES destination for 
   * the specified link
   */
  Ptr<PointToPointNetDeviceGES> GetDestination (uint32_t i) const;
...
private:
  ...
  /**
   * \brief Wire model for the PointToPointChannelGES
   */
  class Link
  {
public:
    ...
    Ptr<PointToPointNetDeviceGES> m_src;   //!< First NetDevice
